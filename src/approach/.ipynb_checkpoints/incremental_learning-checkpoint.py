...
class Inc_Learning_Appr_PPNet(Inc_Learning_Appr):
    ...
    def train(self, t, trn_loader, val_loader, push_loader=None, use_pipnet=False, scheduler_classifier=None, 
              epochs_pretrain=10, freeze_epochs=10, trainloader_pretraining=None, params_to_freeze=None,
              params_to_train=None, params_backbone=None, optimizer_net=None, optimizer_classifier=None,
              scheduler_net=None, device='cpu'):
        """Main train structure"""
    ...
    def train_pipnet(self, train_loader, optimizer_net, optimizer_classifier, scheduler_net, 
                     ...
                     finetune=False, progress_prefix: str = 'Train Epoch', t=None):
        ...
        for i, (x) in train_iter:    
            ...
            loss, acc = self.calculate_loss_pipnet(proto_features, pooled, out, ys,
                                                   align_pf_weight, t_weight, unif_weight, cl_weight,
                                            self.model.module._classification.normalization_multiplier,
                                                   pretrain, finetune, train_iter, verbose=True, EPS=1e-8)
            loss += loss_d
    ...
    def calculate_loss_pipnet(self, proto_features, pooled, out, ys1, align_pf_weight, t_weight, unif_weight,
        ...
        print(f"Target tensor (ys): min={ys.min()}, max={ys.max()}, dtype={ys.dtype}, shape={ys.shape}")
        if not finetune:
    ...
    def train_loop(self, t,
                   ...
                   scheduler_net=None, device='cpu'): #STA USANDO QUESTO
        """Contains the epochs loop"""
        ...
        for e in range(self.nepochs):
            ...
            if self.use_pipnet:
                ...
                train_info = self.train_pipnet(trn_loader, optimizer_net, optimizer_classifier, scheduler_net,
                                          scheduler_classifier, e, device, pretrain=False, finetune=finetune, t=t)
            ...
            #### PATIENCE E EARLY STOPPING ANDRANNO SISTEMATI
#             # Adapt learning rate - patience scheme - early stopping regularization
#             if self.use_pipnet:
...
#                         # self.model.set_state_dict(best_model)
    ...
    # def eval(self, t, val_loader): 
    #     """Contains the evaluation code"""
    #     print("USING EVAL IN INCREMENTAL_LEARNING.PY")
    #     with torch.no_grad():
