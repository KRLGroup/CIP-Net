...
#                 classification_bias.append(param)
    ...
    paramlist_net = [
            {"params": params_backbone, "lr": 0.0005, "weight_decay_rate": 0.0},
            {"params": params_to_freeze, "lr": 0.0005, "weight_decay_rate": 0.0},
            {"params": params_to_train, "lr": 0.0005, "weight_decay_rate": 0.0},
            {"params": net.module._add_on.parameters(), "lr": 0.0005*10., "weight_decay_rate": 0.0}]
            
    paramlist_classifier = [
            {"params": classification_weight, "lr": 0.05, "weight_decay_rate": 0.0},
            {"params": classification_bias, "lr": 0.05, "weight_decay_rate": 0},
    ]
