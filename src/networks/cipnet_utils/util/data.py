...
# from torchvision.transforms.autoaugment import functional as F, InterpolationMode
...
def get_data(args: argparse.Namespace): 
    ...
    if args.cipnetdataset =='CUB-200-2011':   
        return get_birds(True, '../ProtoPNet/datasets/CUB_200_2011/dataset/train_crop', '../ProtoPNet/datasets/CUB_200_2011/dataset/train', '../ProtoPNet/datasets/CUB_200_2011/dataset/test_crop', 224, args.seed, 0, '../ProtoPNet/datasets/CUB_200_2011/dataset/train', '../ProtoPNet/datasets/CUB_200_2011/dataset/test_full')
    else:
        ...
        if args.cipnetdataset == 'CARS':
            return get_cars(True, '../ProtoPNet/datasets/Stanford_Cars_dataset/train', '../ProtoPNet/datasets/Stanford_Cars_dataset/train', '../ProtoPNet/datasets/Stanford_Cars_dataset/test', 224, args.seed, 0)
...
def get_dataloaders(args: argparse.Namespace, device):
    ...
    num_workers = args.num_workers # in ICICLE È 4 IN PIPNET È 8
    
    # if args.weighted_loss: #NON ENTRA QUI CHE È FALSE QUINDI NON LO MODIFICO
    #     if targets is None:
    ...
    pretrain_batchsize = 128 #args.batch_size_pretrain 
...
# class TrivialAugmentWideNoColor(TrivialAugmentWide):
#     def _augmentation_space(self, num_bins: int) -> Dict[str, Tuple[Tensor, bool]]:
#         return {
#             "Identity": (torch.tensor(0.0), False),
...
# class TrivialAugmentWideNoShapeWithColor(TrivialAugmentWide):
#     def _augmentation_space(self, num_bins: int) -> Dict[str, Tuple[Tensor, bool]]:
#         return {
#             "Identity": (torch.tensor(0.0), False),
...
# class TrivialAugmentWideNoShape(TrivialAugmentWide):
#     def _augmentation_space(self, num_bins: int) -> Dict[str, Tuple[Tensor, bool]]:
#         return {
