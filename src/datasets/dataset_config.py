...
# _BASE_DATA_PATH = "/home/fdivaler/XAI_CL/ProtoPNet/datasets/"
_BASE_DATA_PATH = "/raid/home/fdivaler/XAI_CL/ProtoPNet/datasets/"

dataset_config = {

    'cub_200_2011_cropped': {
        'path': join(_BASE_DATA_PATH, 'cub200_cropped/'),
        'resize': (224, 224),
        'crop': None,
        'flip': False,
    ...
    'cars': {
            'path': join(_BASE_DATA_PATH, 'Stanford_Cars_dataset/'),
            'resize': (224, 224),
            'crop': None,
            'flip': False,
            'online_augment': False,
