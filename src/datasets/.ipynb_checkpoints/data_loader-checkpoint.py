...
from networks.pipnet_utils.util.data import TrivialAugmentWideNoColor, TrivialAugmentWideNoShape, TrivialAugmentWideNoShapeWithColor

def get_loaders(datasets, num_tasks, nc_first_task, batch_size, num_workers, pin_memory, validation=.1,
                repeat_task_0=False, use_pipnet=False):
...
def get_cub_datasets(dataset, path, num_tasks, nc_first_task, validation, trn_transform, tst_transform, pipnet=False, transform1=None, transform2=None, transform_noaug=None, class_order=None, repeat_task_0=False):
    """Extract datasets and create Dataset class"""
    ...
    Dataset = basedat.BaseDataset
    if pipnet:
        print("scelto basedatasetpipnet")
        Dataset=basedat.BaseDatasetPIPNet
